...
const DevnetDestinationDomain: Record<Chain, number> = {
  [Chain.ETH]: 0,
  [Chain.AVAX]: 1,
  [Chain.ARB]: 3,
  [Chain.SOLANA]: 5,
...
const MainnetDestinationDomain: Record<Chain, number> = {
  [Chain.ETH]: 0,
  [Chain.AVAX]: 1,
  [Chain.ARB]: 3,
  [Chain.SOLANA]: 5,
...
export const DestinationDomain = process.env.NEXT_PUBLIC_CLUSTER === 'mainnet' ?  MainnetDestinationDomain : DevnetDestinationDomain
